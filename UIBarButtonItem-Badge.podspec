Pod::Spec.new do |s|
  ...
  s.name         = "UIBarButtonItem-Badge-Copy"
  s.version      = "0.0.2"
  ...
  s.homepage     = "https://github.com/kurniadi92/UIBarButtonItem-Badge"
  s.license      = 'MIT'

  s.author       = { "Mike" => "http://mikethinkingoutloud.com" }

  s.source       = { :git => "https://github.com/kurniadi92/UIBarButtonItem-Badge.git" }
